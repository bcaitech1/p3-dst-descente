...
from utils.data_utils import  domain2id, OP_SET, make_turn_label, postprocessing
...
def model_evaluation(model, test_data, tokenizer, slot_meta, epoch, op_code='4',
    ...
    if for_eval:
        ...
        with open('./test_s_logits', 'wb') as f1:
            pickle.dump(s_logits, f1)
        with open('./test_g_logits', 'wb') as f2:
            pickle.dump(g_logits, f2)
