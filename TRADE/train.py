...
from transformers import AdamW, BertTokenizer, get_linear_schedule_with_warmup, AutoTokenizer, AutoConfig
...
from bert_trade_model import BERT_TRADE
...
if __name__ == "__main__":
    ...
    json.dump(
        vars(cfg),
        open(f"{cfg.model_dir}/exp_config.json", "w"),
        indent=2,
        ensure_ascii=False,
    )
    json.dump(
