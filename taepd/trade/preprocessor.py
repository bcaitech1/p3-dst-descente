...
from data_utils import DSTPreprocessor, OpenVocabDSTFeature, convert_state_dict, remove_space, custom_to_mask, get_value
...
class TRADEPreprocessor(DSTPreprocessor):
    ...
    def _sep_custom_convert_example_to_feature(self, example):
        ...
        # [CLS] + [SEP] + tokenized_texts + [SEP] + tokenized_texts + ... + [SEP]
        input_id = (
                [self.src_tokenizer.cls_token_id]
                + input_id
                + [self.src_tokenizer.sep_token_id]
