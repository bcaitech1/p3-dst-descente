...
from modeling_bert import BertPreTrainedModel, BertLMPredictionHead, BertPreTrainingHeads, BertEncoder, BertEmbeddings
from transformers import BertModel, BertTokenizer, ElectraModel, ElectraTokenizer, PreTrainedModel
from copy import deepcopy



class TransformerDST(PreTrainedModel):
    def __init__(self, config, dec_config, n_op, n_domain,
        ...
        ## hard coding ##
        self.bert = BertModel.from_pretrained('dsksd/bert-ko-small-minimal', output_hidden_states=True)
...
class Encoder(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids,
        ...
        all_hidden_states = hidden_states[1:]
        # sequence_output, pooled_output = self.bert_model(input_ids, token_type_ids, attention_mask)
        # embedding_output = self.bert_model.embeddings(input_ids, position_ids=state_positions, token_type_ids=token_type_ids)
      
        # embedding_output = self.bert_model_embedding_weights
