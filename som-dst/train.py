...
def main(args):
    ...
    #.from_pretrained("monologg/koelectra-base-v3-discriminator", additional_special_tokens = ['[SLOT]', '[NULL]','[EOS]', ' ; ']) 
    # BertTokenizer(args.vocab_path, do_lower_case=True) #  
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data", default='new_train_dials_small.json', type=str)
    parser.add_argument("--dev_data", default='new_dev_dials.json', type=str)
    parser.add_argument("--test_data", default='new_eval_dials.json', type=str)
    ...
    parser.add_argument("--decoder_teacher_forcing", default=0, type=float) # default=0.5
